...
export const JourneyNavigation: React.FC<JourneyNavigationProps> = ({ steps, activeStep, onStepClick }) => {
  return (
    <>
      ...
      {/* Position accounts for: main navbar (64px/4rem) + journey header (~110px on desktop) + extra clearance = ~208px total */}
      <div className="hidden lg:block fixed top-52 w-64 bg-white border border-gray-200 rounded-lg shadow-sm p-4 max-h-[calc(100vh-13rem)] overflow-y-auto">
