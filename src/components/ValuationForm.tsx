...
export const ValuationForm: React.FC = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-12 @container">
      ...
      {/* Error Display */}
      {error && (
        <div className="mt-4 p-4 bg-red-50/50 border-l-4 border-red-400 rounded-r-lg animate-in fade-in slide-in-from-top-1">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h3 className="text-sm font-semibold text-red-900 mb-1">Unable to calculate valuation</h3>
              ...
              <button
                ...
                className="text-sm font-medium text-red-700 hover:text-red-900 transition-colors underline decoration-red-300 hover:decoration-red-500"
              >
                Dismiss
              </button>
            </div>
