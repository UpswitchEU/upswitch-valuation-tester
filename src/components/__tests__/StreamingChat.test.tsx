...
describe('StreamingChat Backend-Driven Initialization', () => {
  ...
  describe('Guest User Initialization', () => {
    it('should call backend /start endpoint for guest users', async () => {
      ...
      const mockBackendResponse = {
        ai_message:
          'What type of business do you run? (Select from 173 optimized options including: restaurant, catering, bakery...)',
    ...
    it('should display loading state while initializing', async () => {
      ...
      expect(
        screen.getByText('Preparing your personalized valuation experience...')
      ).toBeInTheDocument()
    })
    ...
    it('should display backend message after successful initialization', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText('What type of business do you run? (Select from 173 optimized options)')
        ).toBeInTheDocument()
      })

      // Loading state should be gone
      expect(
        screen.queryByText('Preparing your personalized valuation experience...')
  ...
  describe('Authenticated User Initialization', () => {
    ...
    it('should call backend with user authentication', async () => {
      const mockBackendResponse = {
        ai_message:
          'Hi John! I see you run a SaaS business. I just need your Monthly Recurring Revenue (MRR) to complete your valuation.',
        field_name: 'mrr',
        input_type: 'number',
