 ...
 */
export const ValuationInfoPanel: React.FC<ValuationInfoPanelProps> = ({ result }) => {
    ...
    <div className="h-full flex flex-col items-center justify-center p-8">
      <div className="text-center max-w-md">
        ...
        <p className="text-sm text-gray-600 mb-4">
          The calculation breakdown is not available. This may indicate an issue with the valuation
          response.
        </p>
