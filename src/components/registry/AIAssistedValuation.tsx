  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row flex-1 overflow-hidden mx-2 sm:mx-4 my-2 sm:my-4 rounded-lg border border-zinc-800">
        {/* Left Panel: Chat/Financial Input (60% on desktop, full width on mobile) - Always visible */}
        ...
        {/* Right Panel: Report Preview (40% on desktop, full width on mobile below chat) */}
