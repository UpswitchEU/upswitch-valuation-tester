    ...
    >
      <div className="max-w-[85%] mr-auto w-full">
        <div className="flex items-start gap-3">
          {/* Success Avatar */}
          <div className="flex-shrink-0 w-8 h-8 bg-green-500/20 rounded-full flex items-center justify-center border border-green-500/30 shadow-lg shadow-green-500/10 mt-1">
            <CheckCircle2 className="w-4 h-4 text-green-400" />
          </div>
          
          <div className="flex flex-col gap-1 w-full">
            {/* Main Confirmation Card */}
            <div className="rounded-2xl rounded-tl-sm overflow-hidden border border-green-500/20 shadow-lg backdrop-blur-sm bg-zinc-900/40">
              
              {/* Header with gradient */}
              <div className="px-5 py-3 bg-gradient-to-r from-green-900/20 to-transparent border-b border-green-500/10 flex items-center justify-between">
                ...
                {confidence && confidence > 0.8 && (
                  <span className="text-[10px] px-1.5 py-0.5 rounded bg-green-500/10 text-green-300 border border-green-500/20">
                    High Confidence
                  </span>
                )}
              </div>
