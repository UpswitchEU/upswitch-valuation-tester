 ...
 *
 * @module features/conversational-valuation/components/ReportPanel
 */
...
export const ReportPanel: React.FC<ReportPanelProps> = React.memo(({ className = '' }) => {
  ...
  return (
    <div className={`h-full min-h-[400px] lg:min-h-0 flex flex-col bg-white overflow-hidden ${className}`}>
      {/* Tab Navigation */}
