 ...
 *
 * Conversational Field Renderer - Renders fields as conversational questions.
 */

import { Bot, HelpCircle } from 'lucide-react';
import React, { useState } from 'react';
import type { DataField, FieldRendererProps, ValidationRule } from '../types';
...
export const ConversationalFieldRenderer: React.FC<FieldRendererProps> = ({
  ...
  // Get question from field or generate one
