...
import { StreamingManager, type StreamingManagerCallbacks } from '../../services/chat/StreamingManager';
import { extractBusinessModelFromInput, extractFoundingYearFromInput } from '../../utils/businessExtractionUtils';
