...
export function createErrorFromStatus(
  ...
  switch (statusCode) {
    ...
    case 409:
      return new SessionConflictError(message, (context?.reportId as string) || 'unknown', context)
    case 422:
    ...
    case 502:
      return new IntegrationError(message, (context?.service as string) || 'Unknown', context)
    case 503:
      return new DatabaseError(message, context)
    case 504:
      return new TimeoutError(message, (context?.timeout_ms as number) || 30000, context)
    default:
