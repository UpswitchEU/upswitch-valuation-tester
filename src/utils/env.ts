...
export const env = {
  ...
  VITE_VALUATION_ENGINE_URL:
    getEnv('VITE_VALUATION_ENGINE_URL') || getEnv('NEXT_PUBLIC_VALUATION_ENGINE_URL'),
  VITE_VALUATION_API_URL:
    getEnv('VITE_VALUATION_API_URL') || getEnv('NEXT_PUBLIC_VALUATION_API_URL'),
  VITE_PYTHON_ENGINE_URL:
    getEnv('VITE_PYTHON_ENGINE_URL') || getEnv('NEXT_PUBLIC_PYTHON_ENGINE_URL'),
  VITE_PARENT_DOMAIN: getEnv('VITE_PARENT_DOMAIN') || getEnv('NEXT_PUBLIC_PARENT_DOMAIN'),
  VITE_UNLIMITED_CREDITS_MODE:
    getEnv('VITE_UNLIMITED_CREDITS_MODE') || getEnv('NEXT_PUBLIC_UNLIMITED_CREDITS_MODE'),
}
